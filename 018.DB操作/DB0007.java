 ...
 * @author PC1
 */
public class DB0007 extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet DB0007</title>");            
            out.println("</head>");
            out.println("<body>");
            ...
            try {
                ...
                db_st = db_con.prepareStatement("UPDATE profiles SET age = 28 WHERE profilesID = 1");
